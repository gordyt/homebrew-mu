...
class Mufixes < Formula
  homepage 'http://www.djcbsoftware.nl/code/mu/'
  url 'https://github.com/gordyt/homebrew-mufixes.git', :using => :git, :tag => "v0.9.9.6"
  head do
    url 'https://github.com/gordyt/homebrew-mufixes.git'
  end
